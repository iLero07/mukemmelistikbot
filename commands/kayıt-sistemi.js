...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`✅ | __**Kayıt Sistemi**__ başarıyla ayarlandı!\n\n<:mavi_gelenkutusu:1119159142830063646> Kayıt Kanalı: ${kayıtkanal}\n<:mavi_bot:1119159116724719687> Kayıtlı Rolü: ${kayıtlırol}\n<:mavi_bot:1119159116724719687> Kayıtsız Rolü: ${kayıtsızrol}`)

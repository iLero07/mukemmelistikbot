    ...
    if(code === db.fetch(`beklenıyor_${interaction.guild.id}${interaction.user.id}`))
      {
      ...
      else
        {
          ...
          new Discord.EmbedBuilder()
          .setColor("#36393F")
          .setDescription('❌ **|** Yanlış kod, tekrar deneyiniz.')
          .setAuthor({ name: interaction.user.tag, iconURL: interaction.user.displayAvatarURL({ dynamic: true })})
        ], ephemeral: true })
        }
  }
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          .setDescription("\n\n**<:mavi_baglanti:1119159101260308540> Linkler**\n> <:mavi_bot:1119159116724719687>・**Botun davet linki: [Tıkla](https://discord.com/api/oauth2/authorize?client_id=1038372156578480199&permissions=8&scope=bot%20applications.commands)**\n> <:duyuru:1039607050734403657>・**Botun destek sunucusu: [Tıkla](https://discord.gg/YE3V2kum)**\n")
          .setColor('Blue')
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:mavi_bot:1119159116724719687> | Al Mazrah - Botlist Menüsü!")
          .addFields(
      ...
      .setColor("Random")
        ...
        if (interaction.customId == "anasayfa_"+interaction.user.id) {
          ...
          .setTitle("・Hangi komutlarım hakkında bilgi almak istiyorsan o butona bas!")
          .setDescription("\n\n**<:mavi_baglanti:1119159101260308540> Linkler**\n> <:mavi_bot:1119159116724719687>・**Botun davet linki: [Tıkla](https://discord.com/oauth2/authorize?client_id=1107593033597337690&scope=bot&permissions=8)**\n> <:mavi_duyuru:1119159133606793339>・**Botun destek sunucusu: [Tıkla](https://discord.gg/YE3V2kum)**\n> <:mavi_arkadasekle:1119159093647650898>")
          .setColor('Blue')
          const row = new Discord.ActionRowBuilder()
          .addComponents(
      new Discord.ButtonBuilder()
      ...
      .addComponents(
        ...
        .setCustomId(".clearMessageButton_"+interaction.user.id)
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <:roket:1044325558563123312> | Al Mazrah - Captcha Menüsü!")
          .addFields(
        ...
        `)
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Al Mazrah Bot - İyi günler diler.')

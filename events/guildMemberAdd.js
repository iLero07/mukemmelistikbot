...
module.exports = {
    ...
    if(giriscikissystem) {
        ...
        const background = await Canvas.loadImage(
          "https://media.discordapp.net/attachments/1101828303968534549/1119628308913598484/gelenmazrah.png"
        );
...
try {
            ...
            channel.send({
                content: `<@${member.user.id}>`, embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .setDescription('• Merhaba Al Mazrah kullanıcısı, seni sunucumuza güvenle alabilmek için altta bulunan yazıyı butona tıklayarak yazman gerekiyor.')
        ...
        registerChannel.send({ content: `${member}`, embeds: [
            {
                description: `<:mavi_developer:1119159123217502279> | Seni aramızda görmekten mutluluk duyuyoruz!\n\n<:mavi_bot:1119159116724719687> | Sunucumuza katılan **${member.guild.memberCount}.** üyesin.\n\n<:mavi_entegrasyon:1119159137788506242> | Hesabın <t:${parseInt(member.user.createdTimestamp  / 1000)}:R> açılmıştır.\n\n❗ | Sunucumuzun kurallarını okumayı unutma iyi eğlenceler.`
            }
        ], components: [row] })
    } catch(err) { }
